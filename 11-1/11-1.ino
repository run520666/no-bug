...
unsigned long leftReleaseTime = 0;   // 左侧小球释放时间
unsigned long rightReleaseTime = 0;  // 右侧小球释放时间
const unsigned long RELEASE_DELAY = 5000;  // 小球释放后延迟复位时间(毫秒)
...
#define SG90_RELATIVE_ANGLE -100    // 释放小球时相对初始位置转动的角度
